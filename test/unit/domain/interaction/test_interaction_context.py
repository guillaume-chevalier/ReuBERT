...
class TestInteractionContext(unittest.TestCase):
    ...
    def test__given__non_switching_input_text__when__fetch_next_interaction_state__then__returns_current_interaction_state(
        self
    ):
    ...
    def test__given__switching_input_text_to_context_statement_interaction_state___when__fetch_next_interaction_state__then__returns_context_statement_interaction_state(
        self
    ):
    ...
    def test__given__switching_input_text_to_question_interaction_state___when__fetch_next_interaction_state__then__returns_question_interaction_state(
        self
    ):
