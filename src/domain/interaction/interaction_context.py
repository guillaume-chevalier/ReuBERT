...
class InteractionContext:
    _INITIAL_INTERACTION_PHASE = InteractionPhase.INTERACTION_INITIALIZATION_PHASE
    ...
    def initiate_interaction(self):
        self.current_interaction_phase = InteractionPhase.INFORMATION_PHASE
        return self._INITIAL_INTERACTION_PHASE
